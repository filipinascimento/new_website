...
import { ArrowUpRight, BookOpen, Code2, Users } from "lucide-react";
    ...
    <main id="main-content">
      <header className="page-hero shell page-hero--split">
        <div>
          ...
          <h1>Learn by making the ideas work.</h1>
        </div>
        ...
        <div className="course-grid">
          {teaching.map((course, index) => (
            <article className="course-card" key={course.slug}>
              <div className="course-card__icon">{index === 0 ? <Code2 size={24} /> : <BookOpen size={24} />}</div>
      ...
      <section className="section section--tint">
        <div className="shell teaching-detail-grid">
          <div>
            <div className="eyebrow"><Users size={14} /> Mentorship</div>
          ...
          <div>
            <div className="eyebrow"><BookOpen size={14} /> Workshops</div>
